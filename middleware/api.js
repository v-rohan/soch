...
export const register = async (data) => {
    try {
        let res = await axios.post(`${BACKEND_URL}api/register/`,
            data, {
            headers: {
...
export const verifyOTP = async (data, token) => {
    try {
        const res = await axios.post(`${BACKEND_URL}api/submitotp/`,
            data, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": token
...
export const getSlotsByPin = async (data, token) => {
    try {
        const res = await axios.post(`${BACKEND_URL}api/base/appts/getByPin/`,
            data, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": token
...
export const getCalendarByCenter = async (data, token) => {
    try {
        const res = await axios.post(`${BACKEND_URL}api/base/appts/getCalendarByCenter`,
            data, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": token
